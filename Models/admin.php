...
//get liste formation admin
//select * from formation, adresse where DATE_FORMAT(CURRENT_DATE(),"%Y-%m-%d") < date_f AND formation.id_a = adresse.id_a
...
//compte cb ya de formation
//SELECT count(*) as nbFormation FROM formation
 function get_nbForm()
    {
        global $bdd;
...
//compte cb ya de prestataire
//SELECT count(*) as nbPrestataire FROM prestataire 
